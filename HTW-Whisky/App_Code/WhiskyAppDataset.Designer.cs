...
namespace HTW_Whisky.App_Code {
    ...
    public partial class WhiskyAppDataset : global::System.Data.DataSet {
        ...
        public partial class pictureDataTable : global::System.Data.TypedTableBase<pictureRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public pictureRow AddpictureRow(aspnet_UsersRow parentaspnet_UsersRowByaspnet_Users_picture, whiskyRow parentwhiskyRowBywhisky_picture, bool allowAll, bool allowFriends, byte[] image) {
        ...
        public partial class pictureRow : global::System.Data.DataRow {
            ...
            public bool allowAll {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte allowAll in Tabelle picture ist DBNull.", e);
                    }
                }
                set {
            ...
            public bool allowFriends {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte allowFriends in Tabelle picture ist DBNull.", e);
                    }
                }
                set {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsallowAllNull() {
                return this.IsNull(this.tablepicture.allowAllColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetallowAllNull() {
                this[this.tablepicture.allowAllColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsallowFriendsNull() {
                return this.IsNull(this.tablepicture.allowFriendsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetallowFriendsNull() {
                this[this.tablepicture.allowFriendsColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class pictureTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [picture] ([userID], [whiskyID], [allowAll], [allowFriends], [image])" +
                " VALUES (@userID, @whiskyID, @allowAll, @allowFriends, @image)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@userID", global::System.Data.SqlDbType.UniqueIdentifier, 0, global::System.Data.ParameterDirection.Input, 0, 0, "userID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@whiskyID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "whiskyID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [picture] SET [userID] = @userID, [whiskyID] = @whiskyID, [allowAll] = @al" +
                "lowAll, [allowFriends] = @allowFriends, [image] = @image WHERE (([ID] = @Origina" +
                "l_ID))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@userID", global::System.Data.SqlDbType.UniqueIdentifier, 0, global::System.Data.ParameterDirection.Input, 0, 0, "userID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@whiskyID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "whiskyID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        ID, userID, whiskyID, allowAll, allowFriends, image\r\nFROM          " +
                "  picture";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        ID, userID, whiskyID, allowAll, allowFriends, image\r\nFROM          " +
                "  picture\r\nWHERE        (userID = @UserID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserID", global::System.Data.SqlDbType.UniqueIdentifier, 16, global::System.Data.ParameterDirection.Input, 0, 0, "userID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        ID, userID, whiskyID, allowAll, allowFriends, image\r\nFROM          " +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.Guid userID, int whiskyID, global::System.Nullable<bool> allowAll, global::System.Nullable<bool> allowFriends, byte[] image) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.Guid)(userID));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(whiskyID));
            if ((allowAll.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((bool)(allowAll.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[2].Value = global::System.DBNull.Value;
            }
            if ((allowFriends.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((bool)(allowFriends.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.Guid userID, int whiskyID, global::System.Nullable<bool> allowAll, global::System.Nullable<bool> allowFriends, byte[] image, int Original_ID) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.Guid)(userID));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(whiskyID));
            if ((allowAll.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((bool)(allowAll.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = global::System.DBNull.Value;
            }
            if ((allowFriends.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((bool)(allowFriends.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
